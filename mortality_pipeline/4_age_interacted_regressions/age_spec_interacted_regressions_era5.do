...
- `output_panels/panel_prepped_for_regressions_ERA5.dta` - Final mortality panel for ERA5.

Outputs
-------

- `output/age_spec_intearacted'
	- `agespec_interaction_response_ERA5_025.ster` - Ster file containing results from
...
* 2)Load the ERA5_025 mortality panel ———
use "/user/ab5405/summeraliaclimate/code/regressions/output_panels/panel_prepped_for_regressions_ERA5.dta", clear
...
reghdfe deathrate_w99 c.tavg_poly_1_ERA5_025#i.agegroup c.tavg_poly_2_ERA5_025#i.agegroup ///
        c.tavg_poly_3_ERA5_025#i.agegroup c.tavg_poly_4_ERA5_025#i.agegroup ///
        c.tavg_poly_1_ERA5_025#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_2_ERA5_025#c.loggdppc_adm1_avg#i.agegroup ///
        c.tavg_poly_3_ERA5_025#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_4_ERA5_025#c.loggdppc_adm1_avg#i.agegroup ///
        c.tavg_poly_1_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup c.tavg_poly_2_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup ///
        c.tavg_poly_3_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup c.tavg_poly_4_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup ///
                , absorb(i.adm2_code#i.CHN_ts#i.agegroup  i.adm0_code#i.year#i.agegroup ) ///
                cluster(adm1_code)


estimates save "`sterdir'/agespec_interaction_response_ERA5_025.ster", replace 
...
if (`altspec') {
	...
	* specification 1
	reghdfe deathrate_w99 c.tavg_poly_1_ERA5_025#i.agegroup c.tavg_poly_2_ERA5_025#i.agegroup ///
		...
		c.tavg_poly_3_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup c.tavg_poly_4_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup ///
			...
			cluster(adm1_code)
	estimates save "`sterdir'/altspec/agespec_response_spec1_interacted_ERA5_025.ster", replace
	...
	* specification 3
	reghdfe deathrate_w99 c.tavg_poly_1_ERA5_025#i.agegroup c.tavg_poly_2_ERA5_025#i.agegroup ///
		...
		c.tavg_poly_3_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup c.tavg_poly_4_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup ///
			...
			cluster(adm1_code)
	estimates save "`sterdir'/altspec/agespec_response_spec3_interacted_ERA5_025.ster", replace
	...
	*****************************************************************************
	...
	preserve
		...
		* specification 4
		...
		estimates save "`sterdir'/altspec/agespec_response_spec4_interacted_ERA5_025.ster", replace
	restore
	...
	* specification 5
	reghdfe deathrate_w99 c.tavg_poly_1_ERA5_025_13m#i.agegroup c.tavg_poly_2_ERA5_025_13m#i.agegroup ///
		c.tavg_poly_3_ERA5_025_13m#i.agegroup c.tavg_poly_4_ERA5_025_13m#i.agegroup ///
		c.tavg_poly_1_ERA5_025_13m#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_2_ERA5_025_13m#c.loggdppc_adm1_avg#i.agegroup ///
		c.tavg_poly_3_ERA5_025_13m#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_4_ERA5_025_13m#c.loggdppc_adm1_avg#i.agegroup ///	
		c.tavg_poly_1_ERA5_025_13m#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup c.tavg_poly_2_ERA5_025_13m#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup ///
		c.tavg_poly_3_ERA5_025_13m#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup c.tavg_poly_4_ERA5_025_13m#c.lr_tavg_ERA5_025_adm1_avg#i.agegroup ///
			, absorb(i.adm2_code#i.CHN_ts#i.agegroup i.adm0_code#i.year#i.agegroup ) ///
			cluster(adm1_code)
	estimates save "`sterdir'/altspec/agespec_response_spec5_interacted_public.ster", replace
