...
* 1) ——— Set up your code and output roots ———
...
* 2) ——— Point to your pre‑merged ERA5_025 mortality panel ———
*    (make sure this .dta exists; it was your R script’s panel_out)
use "/user/ab5405/summeraliaclimate/code/regressions/output_panels/panel_prepped_for_regressions_ERA5_025.dta", clear
