...
local products GMFD ERA5_025 JRA_3Q
...
foreach product of local products {
    ...
    * Spec 1
    reghdfe deathrate_w99 tavg_poly_1_`product' tavg_poly_2_`product' tavg_poly_3_`product' tavg_poly_4_`product' ///
            ...
            cluster(adm1_code)
    estimates save "`ster'/pooled_response_spec1_public_`product'_noint.ster", replace
    ...
    * Spec 2 (preferred)
    ...
    estimates save "`ster'/pooled_response_spec2_public_`product'_noint.ster", replace
    ...
    * Spec 3
    reghdfe deathrate_w99 tavg_poly_1_`product' tavg_poly_2_`product' tavg_poly_3_`product' tavg_poly_4_`product' ///
            ...
            cluster(adm1_code)
    estimates save "`ster'/pooled_response_spec3_public_`product'_noint.ster", replace
    ...
    *****************************************************************************
    ...
    estimates save "`ster'/pooled_response_spec4_public_`product'_noint.ster", replace
    ...
    *****************************************************************************
    ...
    estimates save "`ster'/pooled_response_spec5_public_`product'_noint.ster", replace
