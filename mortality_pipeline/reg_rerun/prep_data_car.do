...
// ——— Set directory paths ———
global CODE   "/user/ab5405/summeraliaclimate/code/regressions/reg_rerun"
global OUTPUT "/user/ab5405/summeraliaclimate/code/regressions/output_panels"

* Load public mortality panel
...
save "$OUTPUT/panel_prepped_for_regression_car.dta", replace
