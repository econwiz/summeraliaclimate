...
use "/user/ab5405/summeraliaclimate/code/global_mortality_panel_public_GMFD.dta", clear
program define _set_output, rclass
    version 17
    if "`OUTPUT'" == "" {
...
save "$OUTPUT/panel_prepped_for_regressions_GMFD.dta", replace
display "✅ Saved ERA5 panel to: $OUTPUT/panel_prepped_for_regressions_GMFD.dta"
