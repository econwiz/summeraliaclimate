...
use "/user/ab5405/summeraliaclimate/code/global_mortality_panel_public_MERRA2.dta", clear
...
save "$OUTPUT/panel_prepped_for_regressions_MERRA2.dta", replace
display "✅ Saved MERRA2 panel to: $OUTPUT/panel_prepped_for_regressions_MERRA2.dta"
