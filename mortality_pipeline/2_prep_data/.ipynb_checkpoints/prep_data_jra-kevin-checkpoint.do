...
use "/user/ab5405/summeraliaclimate/code/regressions/prep_panels/global_mortality_panel_public_JRA_3Q.dta", clear
...
replace sample = 0 if mi(tavg_poly_1_JRA_3Q)
*replace sample = 0 if mi(prcp_poly_1_JRA_3Q)
replace sample = 0 if mi(loggdppc_adm1_avg)
replace sample = 0 if mi(lr_tavg_JRA_3Q_adm1_avg)
...
save "$OUTPUT/panel_prepped_for_regressions_JRA_3Q.dta", replace
display "✅ Saved JRA-3Q panel to: $OUTPUT/panel_prepped_for_regressions_JRA_3Q.dta"
