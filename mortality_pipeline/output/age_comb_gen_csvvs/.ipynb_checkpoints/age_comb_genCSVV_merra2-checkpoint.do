...
* note: locals don’t use “=”
local PRODUCT  "MERRA2"    // or ERA5_025, JRA_3Q, MERRA2

* expand the global with $REPO, not backticks
local STERDIR   "$REPO/code/regressions/output/age_combined_`PRODUCT'"
local CSVVDIR   "$REPO/code/regressions/output/age_combined_`PRODUCT'/csvv"
