...
local STERFILE "$REPO/code/mortality_pipeline/output/age_spec_ALLREA/agespec_prod_interact_spec2_ALLREA.ster"
local CSVVDIR  "$REPO/code/mortality_pipeline/output/age_spec_interacted_csvv"
cap mkdir "`CSVVDIR'"
