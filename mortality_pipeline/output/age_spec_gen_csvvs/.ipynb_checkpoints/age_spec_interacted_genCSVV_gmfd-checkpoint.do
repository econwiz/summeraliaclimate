...
*****************************************************************************
/*****************************************************************************
*  age_combined_csvv.do
*  Run this to convert any age_combined_<PRODUCT>/*.ster into a .csvv
*****************************************************************************

//── 0. Set up repo path & product name ────────────────────────────────────────
if ("$REPO" == "") {
    global REPO : env REPO
}
local PRODUCT = "GMFD"      // <-- change this to ERA5_025, JRA_3Q, MERRA2, or GMFD
local STERDIR = "`REPO'/code/regressions/output/age_combined_`PRODUCT'"
local CSVVDIR = "`STERDIR'/csvv'"
cap mkdir "`CSVVDIR'"
...
forvalues SPEC = 1/5 {
    ...
    *****************************************************************************
    ...
    file write csvv "csvv-version: yourname-2025-07-23" _n
