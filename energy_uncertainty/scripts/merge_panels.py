...
def main() -> None:
    ...
    for prod in PRODUCTS:
        ...
        # Drop any pre-existing climate columns that share names with the new
        # climate data. This is particularly important for GMFD, where the base
        # CIL panel already contains GMFD climate columns — without dropping them
        # the merge would produce duplicate _x/_y suffixed columns.
