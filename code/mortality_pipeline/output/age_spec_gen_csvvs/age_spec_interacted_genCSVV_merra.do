...
- `output/age_spec_interacted_csvv`
    - `agespec_interaction_response_spec2_MERRA2.csvv` - File containing latex output in xlsx format.
...
local STERFILE "agespec_interaction_response_MERRA2.ster"
local CSVVFILE "agespec_interaction_response_spec2_MERRA2.csvv"
