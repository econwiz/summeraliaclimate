...
- `output/age_spec_interacted_csvv`
    - `agespec_interaction_response_spec2_car.csvv` - File containing latex output in xlsx format.
...
local STERFILE "agespec_interaction_response_car.ster"
local CSVVFILE "agespec_interaction_response_spec2_car.csvv"
...
file write csvv "---" _n
file write csvv "oneline: Age‑specific interacted (Spec 2) response – GMFD-Rerun" _n
file write csvv "version: MORTALITY-AGE-SPEC-INTERACTED-GMFD-CAR" _n
