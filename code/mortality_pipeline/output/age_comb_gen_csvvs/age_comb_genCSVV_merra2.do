/*****************************************************************************
*  CSVV GENERATOR FOR AGE‑COMBINED MERRA2 REGRESSIONS (Specs 1–5)             *
*****************************************************************************/

/* PART 0. INITIALIZING */
global REPO   "/user/ab5405/summeraliaclimate"
local PRODUCT "MERRA2"
local STERDIR "$REPO/code/regressions/output/age_combined_MERRA2"
...
forvalues SPEC = 1/5 {
    ...
    file write csvv "---" _n
    file write csvv "oneline: Age‑combined MERRA2 spec`SPEC' results" _n
    file write csvv "version: MORTALITY-AGE-COMBINED-MERRA2-SPEC`SPEC'" _n
    ...
    /* 8. close CSVV */
    file close csvv
    di as txt "✅ Wrote `CSVVFILE' to `CSVVDIR' for MERRA2 spec`SPEC'"
}
