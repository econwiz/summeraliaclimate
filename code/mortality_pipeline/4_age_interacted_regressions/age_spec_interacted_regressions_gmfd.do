...
- `output_panels/panel_prepped_for_regressions_GMFD.dta` - Final mortality panel for GMFD.

Outputs
-------

- `output/age_spec_interacted'
	- `agespec_interaction_response_GMFD.ster` - Ster file containing results from
