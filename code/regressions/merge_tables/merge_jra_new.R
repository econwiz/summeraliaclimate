...
obs_csv   <- "/user/ab5405/summeraliaclimate/code/regressions/generate_obs_data/obs_csvs/JRA_3Q_by_region_year.csv"
panel_out <- "/user/ab5405/summeraliaclimate/code/regressions/prep_data/global_mortality_panel_public_JRA_3Q.dta"
...
#––– 4. Read & prep JRA‑3Q observations (in obs_raw)
...
#––– 6. Rename JRA_3Q cols to uppercase
