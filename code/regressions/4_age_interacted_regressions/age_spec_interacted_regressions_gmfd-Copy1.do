...
* 2) ——— Point to your pre‑merged GMFD mortality panel ———
*    (make sure this .dta exists; it was your R script’s panel_out)
use "/user/ab5405/summeraliaclimate/code/regressions/output_panels/panel_prepped_for_regressions_GMFD.dta", clear
...
reghdfe deathrate_w99                                            ///
    /* 1) temperature quartic × age */                            ///
    c.tavg_poly_1_GMFD#i.agegroup     c.tavg_poly_2_GMFD#i.agegroup    ///
    c.tavg_poly_3_GMFD#i.agegroup     c.tavg_poly_4_GMFD#i.agegroup    ///
                                                                  ///
    /* 2) temperature × income × age */                            ///
    c.tavg_poly_1_GMFD#c.loggdppc_adm1_avg#i.agegroup             ///
    c.tavg_poly_2_GMFD#c.loggdppc_adm1_avg#i.agegroup             ///
    c.tavg_poly_3_GMFD#c.loggdppc_adm1_avg#i.agegroup             ///
    c.tavg_poly_4_GMFD#c.loggdppc_adm1_avg#i.agegroup             ///
                                                                  ///
    /* 3) temperature × long‑run mean temp × age */                ///
    c.tavg_poly_1_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup         ///
    c.tavg_poly_2_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup         ///
    c.tavg_poly_3_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup         ///
    c.tavg_poly_4_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup         ///
                                                                  ///
  ,                                                               ///
    absorb(                                                       ///
      /* a) country×age intercepts */                             ///
      i.adm0_agegrp_code                                          ///
      /* b) country×age × prcp_poly_1 */                          ///
      i.adm0_agegrp_code#c.prcp_poly_1_GMFD#i.agegroup            ///
      /* c) country×age × prcp_poly_2 */                          ///
      i.adm0_agegrp_code#c.prcp_poly_2_GMFD#i.agegroup            ///
      /* d) ADM2 seasonality + China break by age */              ///
      i.adm2_code#i.CHN_ts#i.agegroup                             ///
      /* e) country×year shocks by age */                         ///
...
reghdfe deathrate_w99 c.tavg_poly_1_GMFD#i.agegroup c.tavg_poly_2_GMFD#i.agegroup ///
 ...
 /* country×age‑specific precip polynomials */       ///
    adm0_agegrp_code##c.prcp_poly_1_GMFD                ///
    adm0_agegrp_code##c.prcp_poly_2_GMFD                ///
        , absorb(i.adm2_code#i.CHN_ts#i.agegroup            ///
                 i.adm0_code#i.year#i.agegroup)             ///
          cluster(adm1_code
...
reghdfe deathrate_w99 c.tavg_poly_1_GMFD#i.agegroup c.tavg_poly_2_GMFD#i.agegroup ///
	...
	c.tavg_poly_3_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup c.tavg_poly_4_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup ///
            , absorb(i.adm2_code#i.CHN_ts#i.agegroup  i.adm0_code#i.year#i.agegroup ) ///
                        cluster(adm1_code)
estimates save "`sterdir'/agespec_interaction_response_GMFD.ster", replace 
	...
	* specification 1
	reghdfe deathrate_w99 c.tavg_poly_1_GMFD#i.agegroup c.tavg_poly_2_GMFD#i.agegroup ///
		...
		c.tavg_poly_3_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup c.tavg_poly_4_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup ///
			...
			cluster(adm1_code)
	estimates save "`sterdir'/altspec/agespec_response_spec1_interacted_GMFD.ster", replace
	...
	* specification 3
	reghdfe deathrate_w99 c.tavg_poly_1_GMFD#i.agegroup c.tavg_poly_2_GMFD#i.agegroup ///
		...
		c.tavg_poly_3_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup c.tavg_poly_4_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup ///
			...
			cluster(adm1_code)
	estimates save "`sterdir'/altspec/agespec_response_spec3_interacted_GMFD.ster", replace
	...
	*****************************************************************************
	...
	preserve
		...
		* specification 4
		...
		estimates save "`sterdir'/altspec/agespec_response_spec4_interacted_GMFD.ster", replace
	restore
