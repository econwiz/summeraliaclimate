...
- `output_panels/panel_prepped_for_regressions_JRA_3Q.dta` - Final mortality panel for JRA-3Q.

Outputs
-------

- `output/age_spec_interacted'
	- `agespec_interaction_response_JRA_3Q.ster` - Ster file containing results from
...
reghdfe deathrate_w99 c.tavg_poly_1_JRA_3Q#i.agegroup c.tavg_poly_2_JRA_3Q#i.agegroup ///
        c.tavg_poly_3_JRA_3Q#i.agegroup c.tavg_poly_4_JRA_3Q#i.agegroup ///
        c.tavg_poly_1_JRA_3Q#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_2_JRA_3Q#c.loggdppc_adm1_avg#i.agegroup ///
        c.tavg_poly_3_JRA_3Q#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_4_JRA_3Q#c.loggdppc_adm1_avg#i.agegroup ///
        c.tavg_poly_1_JRA_3Q#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup c.tavg_poly_2_JRA_3Q#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup ///
        c.tavg_poly_3_JRA_3Q#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup c.tavg_poly_4_JRA_3Q#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup ///
			, absorb(i.adm2_code#i.CHN_ts#i.agegroup i.adm0_code#i.year#i.agegroup adm1_agegrp_code##c.year) ///
			cluster(adm1_code)

estimates save "`sterdir'/agespec_interaction_response_JRA_3Q.ster", replace 
...
if (`altspec') {
	...
	* specification 1
	reghdfe deathrate_w99 c.tavg_poly_1_JRA_3Q#i.agegroup c.tavg_poly_2_JRA_3Q#i.agegroup ///
		...
		c.tavg_poly_3_JRA_3Q#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup c.tavg_poly_4_JRA_3Q#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup ///
			...
			cluster(adm1_code)
	estimates save "`sterdir'/altspec/agespec_response_spec1_interacted_JRA_3Q.ster", replace
	...
	* specification 3
	reghdfe deathrate_w99 c.tavg_poly_1_JRA_3Q#i.agegroup c.tavg_poly_2_JRA_3Q#i.agegroup ///
		...
		c.tavg_poly_3_JRA_3Q#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup c.tavg_poly_4_JRA_3Q#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup ///
			, absorb(i.adm2_code#i.CHN_ts#i.agegroup i.adm0_code#i.year#i.agegroup adm1_agegrp_code##c.year) ///
			cluster(adm1_code)
	estimates save "`sterdir'/altspec/agespec_response_spec3_interacted_JRA_3Q.ster", replace
	...
	*****************************************************************************
	...
	preserve
		...
		* specification 4
		...
		estimates save "`sterdir'/altspec/agespec_response_spec4_interacted_JRA_3Q.ster", replace
	restore
	...
	* specification 5
	reghdfe deathrate_w99 c.tavg_poly_1_JRA_3Q_13m#i.agegroup c.tavg_poly_2_JRA_3Q_13m#i.agegroup ///
		c.tavg_poly_3_JRA_3Q_13m#i.agegroup c.tavg_poly_4_JRA_3Q_13m#i.agegroup ///
		c.tavg_poly_1_JRA_3Q_13m#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_2_JRA_3Q_13m#c.loggdppc_adm1_avg#i.agegroup ///
		c.tavg_poly_3_JRA_3Q_13m#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_4_JRA_3Q_13m#c.loggdppc_adm1_avg#i.agegroup ///	
		c.tavg_poly_1_JRA_3Q_13m#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup c.tavg_poly_2_JRA_3Q_13m#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup ///
		c.tavg_poly_3_JRA_3Q_13m#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup c.tavg_poly_4_JRA_3Q_13m#c.lr_tavg_JRA_3Q_adm1_avg#i.agegroup ///
			, absorb(i.adm2_code#i.CHN_ts#i.agegroup i.adm0_code#i.year#i.agegroup ) ///
			cluster(adm1_code)
