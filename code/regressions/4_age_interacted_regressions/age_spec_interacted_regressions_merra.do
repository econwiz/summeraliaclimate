...
- `output_panels/panel_prepped_for_regressions_MERRA2.dta` - Final mortality panel for MERRA2.

Outputs
-------

- `output/age_spec_interacted_MERRA2'
	- `agespec_interaction_response_MERRA2.ster` - Ster file containing results from
...
* 2)  Load MERRA2 mortality panel
*    (make sure this .dta exists; it was your R script’s panel_out)
use "/user/ab5405/summeraliaclimate/code/regressions/output_panels/panel_prepped_for_regressions_MERRA2.dta", clear
...
* 1. run regressions
* specification 
reghdfe deathrate_w99 c.tavg_poly_1_MERRA2#i.agegroup c.tavg_poly_2_MERRA2#i.agegroup ///
	c.tavg_poly_3_MERRA2#i.agegroup c.tavg_poly_4_MERRA2#i.agegroup ///
	c.tavg_poly_1_MERRA2#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_2_MERRA2#c.loggdppc_adm1_avg#i.agegroup ///
	c.tavg_poly_3_MERRA2#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_4_MERRA2#c.loggdppc_adm1_avg#i.agegroup ///
	c.tavg_poly_1_MERRA2#c.lr_tavg_MERRA2_adm1_avg#i.agegroup c.tavg_poly_2_MERRA2#c.lr_tavg_MERRA2_adm1_avg#i.agegroup ///
	c.tavg_poly_3_MERRA2#c.lr_tavg_MERRA2_adm1_avg#i.agegroup c.tavg_poly_4_MERRA2#c.lr_tavg_MERRA2_adm1_avg#i.agegroup ///
			, absorb(i.adm2_code#i.CHN_ts#i.agegroup i.adm0_code#i.year#i.agegroup adm1_agegrp_code##c.year) ///
			cluster(adm1_code)

estimates save "`sterdir'/agespec_interaction_response_MERRA2.ster", replace 
...
if (`altspec') {
	...
	* specification 1
	reghdfe deathrate_w99 c.tavg_poly_1_MERRA2#i.agegroup c.tavg_poly_2_MERRA2#i.agegroup ///
		...
		c.tavg_poly_3_MERRA2#c.lr_tavg_MERRA2_adm1_avg#i.agegroup c.tavg_poly_4_MERRA2#c.lr_tavg_MERRA2_adm1_avg#i.agegroup ///
			...
			cluster(adm1_code)
	estimates save "`sterdir'/altspec/agespec_response_spec1_interacted_MERRA2.ster", replace
	...
	* specification 3
	reghdfe deathrate_w99 c.tavg_poly_1_MERRA2#i.agegroup c.tavg_poly_2_MERRA2#i.agegroup ///
		...
		c.tavg_poly_3_MERRA2#c.lr_tavg_MERRA2_adm1_avg#i.agegroup c.tavg_poly_4_MERRA2#c.lr_tavg_MERRA2_adm1_avg#i.agegroup ///
			, absorb(i.adm2_code#i.CHN_ts#i.agegroup i.adm0_code#i.year#i.agegroup adm1_agegrp_code##c.year) ///
			cluster(adm1_code)
	estimates save "`sterdir'/altspec/agespec_response_spec3_interacted_MERRA2.ster", replace
	...
	*****************************************************************************
	...
	preserve
		...
		* specification 4
		...
		estimates save "`sterdir'/altspec/agespec_response_spec4_interacted_MERRA2.ster", replace
	restore
	...
	* specification 5
	reghdfe deathrate_w99 c.tavg_poly_1_MERRA2_13m#i.agegroup c.tavg_poly_2_MERRA2_13m#i.agegroup ///
		c.tavg_poly_3_MERRA2_13m#i.agegroup c.tavg_poly_4_MERRA2_13m#i.agegroup ///
		c.tavg_poly_1_MERRA2_13m#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_2_MERRA2_13m#c.loggdppc_adm1_avg#i.agegroup ///
		c.tavg_poly_3_MERRA2_13m#c.loggdppc_adm1_avg#i.agegroup c.tavg_poly_4_MERRA2_13m#c.loggdppc_adm1_avg#i.agegroup ///	
		c.tavg_poly_1_MERRA2_13m#c.lr_tavg_MERRA2_adm1_avg#i.agegroup c.tavg_poly_2_MERRA2_13m#c.lr_tavg_MERRA2_adm1_avg#i.agegroup ///
		c.tavg_poly_3_MERRA2_13m#c.lr_tavg_MERRA2_adm1_avg#i.agegroup c.tavg_poly_4_MERRA2_13m#c.lr_tavg_MERRA2_adm1_avg#i.agegroup ///
			, absorb(i.adm2_code#i.CHN_ts#i.agegroup i.adm0_code#i.year#i.agegroup ) ///
			cluster(adm1_code)
