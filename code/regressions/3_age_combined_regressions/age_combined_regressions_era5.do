...
- `regressions/prep_panels/global_mortality_panel_public_ERA5_025.dta` - Final mortality panel.

Outputs
-------

- `regressions/output_panels`
	- `pooled_response_spec*_ERA5.ster` where * is model 1 through 5. Ster files
...
local ster "$OUTPUT/age_combined_ERA5"
...
* specification 1
reghdfe deathrate_w99 tavg_poly_1_ERA5_025 tavg_poly_2_ERA5_025 tavg_poly_3_ERA5_025 tavg_poly_4_ERA5_025 ///
		[pw = weight]  ///
		, absorb(adm0_code##c.prcp_poly_1_ERA5_025 adm0_code##c.prcp_poly_2_ERA5_025 ///
				i.adm2_code#i.CHN_ts#i.agegroup i.adm0_code#i.year ) ///
		cluster(adm1_code)
estimates save "`ster'/pooled_response_spec1_public_ERA5.ster", replace
...
estimates save "`ster'/pooled_response_spec2_public_ERA5.ster", replace
...
reghdfe deathrate_w99 tavg_poly_1_ERA5_025 tavg_poly_2_ERA5_025 tavg_poly_3_ERA5_025 tavg_poly_4_ERA5_025 ///
		...
		cluster(adm1_code)
estimates save "`ster'/pooled_response_spec3_public_ERA5.ster", replace
...
estimates save "`ster'/pooled_response_spec4_public_ERA5.ster", replace
...
reghdfe deathrate_w99                                                             ///
    ...
    c.tavg_poly_1_ERA5_025   c.tavg_poly_2_ERA5_025   c.tavg_poly_3_ERA5_025   c.tavg_poly_4_ERA5_025    ///
                                                                                  ///
    /* 2) Temp × income */                                                         ///
    c.tavg_poly_1_ERA5_025#c.loggdppc_adm1_avg   ///
    c.tavg_poly_2_ERA5_025#c.loggdppc_adm1_avg   ///
    c.tavg_poly_3_ERA5_025#c.loggdppc_adm1_avg   ///
    c.tavg_poly_4_ERA5_025#c.loggdppc_adm1_avg   ///
                                                                                  ///
    /* 3) Temp × LR‑mean‑temp */                                                   ///
    c.tavg_poly_1_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg   ///
    c.tavg_poly_2_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg   ///
    c.tavg_poly_3_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg   ///
    c.tavg_poly_4_ERA5_025#c.lr_tavg_ERA5_025_adm1_avg   ///
                                                                                  ///
    [pw = weight],                                                                 ///
    absorb(                                                                         ///
      /* a) country‑specific precip polynomials */                                  ///
      adm0_code##c.prcp_poly_1_ERA5_025                                              ///
      adm0_code##c.prcp_poly_2_ERA5_025                                              ///
                                                                                  ///
...
estimates save "`ster'/pooled_response_spec5_public_ERA5.ster", replace