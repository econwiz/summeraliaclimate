...
- `regressions/prep_panels/global_mortality_panel_public_MERRA2.dta` - Final mortality panel.

Outputs
-------

- `regressions/output_panels`
	- `pooled_response_spec*_MERRA2.ster` where * is model 1 through 5. Ster files
...
local ster "$OUTPUT/age_combined_MERRA2"
...
reghdfe deathrate_w99                                                             ///
    ...
    c.tavg_poly_1_MERRA2   c.tavg_poly_2_MERRA2  c.tavg_poly_3_MERRA2   c.tavg_poly_4_MERRA2    ///
                                                                                  ///
    /* 2) Temp × income */                                                         ///
    c.tavg_poly_1_MERRA2#c.loggdppc_adm1_avg   ///
    c.tavg_poly_2_MERRA2#c.loggdppc_adm1_avg   ///
    c.tavg_poly_3_MERRA2#c.loggdppc_adm1_avg   ///
    c.tavg_poly_4_MERRA2#c.loggdppc_adm1_avg   ///
                                                                                  ///
    /* 3) Temp × LR‑mean‑temp */                                                   ///
    c.tavg_poly_1_MERRA2#c.lr_tavg_MERRA2_adm1_avg   ///
    c.tavg_poly_2_MERRA2#c.lr_tavg_MERRA2_adm1_avg   ///
    c.tavg_poly_3_MERRA2#c.lr_tavg_MERRA2_adm1_avg   ///
    c.tavg_poly_4_MERRA2#c.lr_tavg_MERRA2_adm1_avg   ///
                                                                                  ///
    [pw = weight],                                                                 ///
    absorb(                                                                         ///
...
estimates save "`ster'/pooled_response_spec5_public_MERRA2.ster", replace