...
- `regressions/prep_panels/global_mortality_panel_public_GMFD.dta` - Final mortality panel.

Outputs
-------

- `regressions/output_panels`
	- `pooled_response_spec*_GMFD.ster` where * is model 1 through 5. Ster files
...
local ster "$OUTPUT/age_combined_GMFD"

* create the results folder if it doesn't exist
capture mkdir "`ster'"

* 1. Load the prepped GMFD panel
...
reghdfe deathrate_w99 tavg_poly_1_GMFD tavg_poly_2_GMFD tavg_poly_3_GMFD tavg_poly_4_GMFD ///
		...
		cluster(adm1_code)
estimates save "`ster'/pooled_response_spec1_public_GMFD.ster", replace
...
estimates save "`ster'/pooled_response_spec2_public_GMFD.ster", replace
...
reghdfe deathrate_w99 tavg_poly_1_GMFD tavg_poly_2_GMFD tavg_poly_3_GMFD tavg_poly_4_GMFD ///
		...
		cluster(adm1_code)
estimates save "`ster'/pooled_response_spec3_public_GMFD.ster", replace
...
estimates save "`ster'/pooled_response_spec4_public_GMFD.ster", replace
...
reghdfe deathrate_w99                                                             ///
    ...
    c.tavg_poly_1_GMFD   c.tavg_poly_2_GMFD  c.tavg_poly_3_GMFD   c.tavg_poly_4_GMFD    ///
                                                                                  ///
    /* 2) Temp × income */                                                         ///
    c.tavg_poly_1_GMFD#c.loggdppc_adm1_avg   ///
    c.tavg_poly_2_GMFD#c.loggdppc_adm1_avg   ///
    c.tavg_poly_3_GMFD#c.loggdppc_adm1_avg   ///
    c.tavg_poly_4_GMFD#c.loggdppc_adm1_avg   ///
                                                                                  ///
    /* 3) Temp × LR‑mean‑temp */                                                   ///
    c.tavg_poly_1_GMFD#c.lr_tavg_GMFD_adm1_avg   ///
    c.tavg_poly_2_GMFD#c.lr_tavg_GMFD_adm1_avg   ///
    c.tavg_poly_3_GMFD#c.lr_tavg_GMFD_adm1_avg   ///
    c.tavg_poly_4_GMFD#c.lr_tavg_GMFD_adm1_avg   ///
                                                                                  ///
    [pw = weight],                                                                 ///
    absorb(                                                                         ///
      /* a) country‑specific precip polynomials */                                  ///
      adm0_code##c.prcp_poly_1_GMFD                                             ///
      adm0_code##c.prcp_poly_2_GMFD                                              ///
                                                                                  ///
...
estimates save "`ster'/pooled_response_spec5_public_GMFD.ster", replace