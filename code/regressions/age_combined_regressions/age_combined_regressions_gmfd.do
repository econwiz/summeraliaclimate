...
reghdfe deathrate_w99 tavg_poly_1_GMFD tavg_poly_2_GMFD tavg_poly_3_GMFD tavg_poly_4_GMFD ///
		...
		cluster(adm1_code)
estimates save "`sterdir'/pooled_response_spec1_public_GMFD.ster", replace
...
estimates save "`sterdir'/pooled_response_spec2_public_GMFD.ster", replace
...
reghdfe deathrate_w99 tavg_poly_1_GMFD tavg_poly_2_GMFD tavg_poly_3_GMFD tavg_poly_4_GMFD ///
		...
		cluster(adm1_code)
estimates save "`sterdir'/pooled_response_spec3_public_GMFD.ster", replace
...
estimates save "`sterdir'/pooled_response_spec4_public_GMFD.ster", replace
...
*		, absorb(adm0_code##c.prcp_poly_1_GMFD adm0_code##c.prcp_poly_2_GMFD ///
		...
		*cluster(adm1_code)
*estimates save "`sterdir'/pooled_response_spec5_public_GMFD.ster", replace
