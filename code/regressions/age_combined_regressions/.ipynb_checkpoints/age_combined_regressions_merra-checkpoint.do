...
* 1. Load the prepped MERRA2 panel
use "$OUTPUT/panel_prepped_for_regressions_MERRA2.dta", clear
...
reghdfe deathrate_w99 tavg_poly_1_MERRA2 tavg_poly_2_MERRA2 tavg_poly_3_MERRA2 tavg_poly_4_MERRA2 ///
		...
		cluster(adm1_code)
estimates save "`sterdir'/pooled_response_spec1_public_MERRA2.ster", replace
...
estimates save "`sterdir'/pooled_response_spec2_public_MERRA2.ster", replace
...
reghdfe deathrate_w99 tavg_poly_1_MERRA2 tavg_poly_2_MERRA2 tavg_poly_3_MERRA2 tavg_poly_4_MERRA2 ///
		...
		cluster(adm1_code)
estimates save "`sterdir'/pooled_response_spec3_public_MERRA2.ster", replace
...
estimates save "`sterdir'/pooled_response_spec4_public_MERRA2.ster", replace
...
* specification 5
*reghdfe deathrate_w99 tavg_poly_1_MERRA2_13m tavg_poly_2_MERRA2_13m tavg_poly_3_MERRA2_13m tavg_poly_4_MERRA2_13m ///
*		[pw = weight] ///
*		, absorb(adm0_code##c.prcp_poly_1_MERRA2 adm0_code##c.prcp_poly_2_MERRA2 ///
		...
		*cluster(adm1_code)
*estimates save "`sterdir'/pooled_response_spec5_public_MERRA2.ster", replace
