...
local sterdir "$OUTPUT/age_combined_JRA_3Q"

* create the results folder if it doesn't exist
capture mkdir "`sterdir'"

* 1. Load the prepped JRA-3Q panel
use "$OUTPUT/panel_prepped_for_regressions_JRA_3Q.dta", clear
...
reghdfe deathrate_w99 tavg_poly_1_JRA_3Q tavg_poly_2_JRA_3Q tavg_poly_3_JRA_3Q tavg_poly_4_JRA_3Q ///
		...
		cluster(adm1_code)
estimates save "`sterdir'/pooled_response_spec1_public_JRA_3Q.ster", replace
...
estimates save "`sterdir'/pooled_response_spec2_public_JRA_3Q.ster", replace
...
reghdfe deathrate_w99 tavg_poly_1_JRA_3Q tavg_poly_2_JRA_3Q tavg_poly_3_JRA_3Q tavg_poly_4_JRA_3Q ///
		...
		cluster(adm1_code)
estimates save "`sterdir'/pooled_response_spec3_public_JRA_3Q.ster", replace
...
estimates save "`sterdir'/pooled_response_spec4_public_JRA_3Q.ster", replace
...
* specification 5
*reghdfe deathrate_w99 tavg_poly_1_JRA_3Q_13m tavg_poly_2_JRA_3Q_13m tavg_poly_3_JRA_3Q_13m tavg_poly_4_JRA_3Q_13m ///
*		[pw = weight] ///
*		, absorb(adm0_code##c.prcp_poly_1_JRA_3Q adm0_code##c.prcp_poly_2_JRA_3Q ///
		...
		*cluster(adm1_code)
*estimates save "`sterdir'/pooled_response_spec5_public_JRA_3Q.ster", replace
