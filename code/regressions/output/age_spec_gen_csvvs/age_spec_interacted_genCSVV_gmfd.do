...
- `output/age_spec_interacted_csvv`
    - `agespec_interaction_response_spec2_GMFD.csvv` - File containing latex output in xlsx format.
...
* We only carry forward Spec 2 for GMFD:
local STERFILE "agespec_interaction_response_GMFD.ster"
local CSVVFILE "agespec_interaction_response_spec2_GMFD.csvv"
...
file write csvv "---" _n
file write csvv "oneline: Age‑specific interacted (Spec 2) response – GMFD" _n
file write csvv "version: MORTALITY-AGE-SPEC-INTERACTED-GMFD" _n
