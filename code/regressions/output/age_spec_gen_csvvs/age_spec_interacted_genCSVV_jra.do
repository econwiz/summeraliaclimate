...
- `output/age_spec_interacted_csvv`
    - `agespec_interaction_response_spec2_JRA_3Q.csvv` - File containing latex output in xlsx format.
...
* We only carry forward Spec 2 for JRA_3Q:
local STERFILE "agespec_interaction_response_JRA_3Q.ster"
local CSVVFILE "agespec_interaction_response_spec2_JRA_3Q.csvv"
...
file write csvv "---" _n
file write csvv "oneline: Age‑specific interacted (Spec 2) response – JRA_3Q" _n
file write csvv "version: MORTALITY-AGE-SPEC-INTERACTED-JRA_3Q" _n
