/*****************************************************************************
*  CSVV GENERATOR FOR AGE‑COMBINED ER5 REGRESSIONS (Specs 1–5)             *
*****************************************************************************/

/* PART 0. INITIALIZING */
global REPO   "/user/ab5405/summeraliaclimate"
local PRODUCT "ERA5"
local STERDIR "$REPO/code/regressions/output/age_combined_ERA5"
...
forvalues SPEC = 1/5 {
    ...
    file write csvv "---" _n
    file write csvv "oneline: Age‑combined ERA5 spec`SPEC' results" _n
    file write csvv "version: MORTALITY-AGE-COMBINED-ERA5-SPEC`SPEC'" _n
    ...
    /* 8. close CSVV */
    file close csvv
    di as txt "✅ Wrote `CSVVFILE' to `CSVVDIR' for ERA5 spec`SPEC'"
}
